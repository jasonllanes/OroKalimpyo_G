...
public class guess_the_waste_game extends AppCompatActivity implements View.OnClickListener {
        ...
        Runnable refresh = new Runnable() {
            ...
            public void run() {
                ...
                if(Integer.parseInt(tvStars.getText().toString()) == 1){
                    ...
                    lStar1.setAnimation(R.raw.lottie_star_default);
                    lStar2.setAnimation(R.raw.lottie_star_default);
                    lStar3.setAnimation(R.raw.lottie_star_default);
                    lStar4.setAnimation(R.raw.lottie_star_default);
                    lStar5.setAnimation(R.raw.lottie_star_default);
    ...
    public void onClick(View view) {
        ...
        if(id == R.id.btnWaste1){
            ...
            fc.updateStar(progressBar,btnReset,guess_the_waste_game.this,"waste_game_level",mAuth.getUid(),0);
        }
