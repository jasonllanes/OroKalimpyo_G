...
public class collector_sign_up_details extends AppCompatActivity implements View.OnClickListener {

    ImageView ivBack;
    EditText etName,etAccreditation,etContactPerson,etNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collector_sign_up_details);
        ...
        sUserType.setItems(of.populateUserTypeCollector());
        sUserType.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(MaterialSpinner view, int position, long id, Object item) {
                ...
                if(view.getText().toString().trim().equalsIgnoreCase("Private Collector")){
                    ...
                    customSnackBar.setTextColor(ContextCompat.getColor(collector_sign_up_details.this,R.color.white));
                    customSnackBar.setBackgroundTint(ContextCompat.getColor(collector_sign_up_details.this,R.color.green));
                    customSnackBar.show();
                }else{
    ...
    public void onClick(View v) {
        ...
        if(id == R.id.ivBack){
            ...
            if(etName.getText().toString().isEmpty()){
                ...
                if(sUserType.getText().toString().equalsIgnoreCase("Private Collector")){
                    Intent i = new Intent(collector_sign_up_details.this, final_sign_up_2.class);
                    i.putExtra("user_type", user_type);
                    i.putExtra("collector_type", sUserType.getText().toString().trim());
                    i.putExtra("accreditation",etAccreditation.getText().toString().trim());
